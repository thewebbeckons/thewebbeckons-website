# TheWebBeckons Design System

A bold, opinionated, minimal-code magazine aesthetic. Black is the dominant tone; BMW M blue is the singular editorial accent; red exists only for semantic error states. Sharp square edges, flat surfaces, massive headlines, stark black-on-white contrast.
...
| Secondary | `#1C69D4` | BMW M blue — accent, emphasis, editorial highlights |
...
> **Accent discipline:** BMW M blue `#1C69D4` is the single editorial accent. Red `#EF4444` is used **only** for semantic error and destructive states — never for highlights, hover accents, pull quotes, or featured borders. The accent is a scalpel, not a paintbrush.
...
**Philosophy:** Thewebbeckons is completely flat with borders. Hierarchy comes from weight, scale, and black-white contrast — never from elevation.
...
**Special — Focus Ring:** `0 0 0 2px #FAFAFA, 0 0 0 4px #1C69D4` — stark BMW M blue focus indicator.

**Special — Accent Underline:** A 3px bottom border in `#1C69D4` used as a highlight accent on featured articles and active nav items.
...
- Radius: 0px
- Hover: Background `#1C69D4`, border `#1C69D4`, text `#FAFAFA`
- Active: Background `#0F4DA8`, border `#0F4DA8`, text `#FAFAFA`
...
- Focus: Border `#0A0A0A`, ring `0 0 0 2px #FAFAFA, 0 0 0 4px #1C69D4`
- Error: Border `#EF4444`
...
- Text: `#525252`
- Selected: Background `#1C69D4`, text `#FAFAFA`, border `#1C69D4`
...
- Radius: 0px
- Background: `#FAFAFA`
- Checked: Background `#1C69D4`, border `#1C69D4`, checkmark `#FAFAFA`
- Indeterminate: Background `#1C69D4`, dash `#FAFAFA`
- Hover: Background `#F5F5F5`
- Focus: Ring `0 0 0 2px #FAFAFA, 0 0 0 4px #1C69D4`
...
- Radius: 9999px
- Background: `#FAFAFA`
- Selected: Border `#1C69D4`, inner dot `#1C69D4` (8px)
- Hover: Background `#F5F5F5`
- Focus: Ring `0 0 0 2px #FAFAFA, 0 0 0 4px #1C69D4`
- Disabled: Opacity 0.35
- Label: Work Sans, 14px, weight 400, margin-left 10px
...
2. **Don't** use BMW M blue (`#1C69D4`) for more than one element per viewport — it is a scalpel, not a paintbrush.
...
5. **Do** use pull quotes styled with a left `4px solid #1C69D4` border and Body Large italic.
...
10. **Do** use the BMW M blue accent on hover states for primary buttons to create a visceral interaction cue.
11. **Don't** use red (`#EF4444`) outside of semantic error and destructive states — it never serves as an editorial accent.
